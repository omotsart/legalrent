...
*Ищет по договорам двумя способами сразу — по словам и по смыслу. Решения принимает код по явным правилам, LLM (GigaChat) лишь извлекает факты и формулирует текст. Любой ответ можно проверить за 15 секунд*
...
Напишите: [ovm26rus@yandex.ru](mailto:ovm26rus@yandex.ru)


## 👤 Автор

Проект на стыке двух дисциплин: **15 лет юридической практики + LLM-инженерия**. Playbook оценки договоров, категории правок и eval-датасеты собраны из реальной практики, а не сгенерированы — это и определяет ценность системы.
