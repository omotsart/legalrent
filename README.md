...
*Ищет по договорам двумя способами сразу — по словам и по смыслу. Решения принимает код по явным правилам, LLM лишь извлекает факты и формулирует текст. Любой ответ можно проверить за 15 секунд*
